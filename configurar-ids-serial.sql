-- Script para configurar IDs automáticos en las tablas
-- Ejecuta este script en Supabase Dashboard → SQL Editor
-- Esto hará que los IDs se generen automáticamente

-- Configurar secuencias para cada tabla
-- Esto permite que los IDs se generen automáticamente incluso si no usamos SERIAL
